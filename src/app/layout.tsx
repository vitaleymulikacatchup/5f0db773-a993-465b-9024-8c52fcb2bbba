...
export const metadata: Metadata = {
  title: "Kristo Timuska - Professional Track & Field Athlete",
  description: "Professional track and field athlete specializing in sprint events. View achievements, statistics, and get in touch for training or sponsorship opportunities.",
  keywords: "Kristo Timuska, track and field, sprint athlete, 100m, 200m, professional runner, athletic training",
  openGraph: {
    title: "Kristo Timuska - Professional Track & Field Athlete",
    description: "Professional track and field athlete specializing in sprint events with multiple championship titles and record-breaking performances.",
    siteName: "Kristo Timuska",
    images: [
      {
        url: "https://images.pexels.com/photos/936094/pexels-photo-936094.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "Kristo Timuska in competition"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "Kristo Timuska - Professional Track & Field Athlete",
    description: "Professional track and field athlete specializing in sprint events with multiple championship titles.",
    images: ["https://images.pexels.com/photos/936094/pexels-photo-936094.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
